#
#  Be sure to run `pod spec lint HiCall.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "HiCall"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of HiCall."
  ...
  spec.source       = { :git => "https://github.com/hiappgus/HiCall.git", :tag => "#{spec.version}" }
